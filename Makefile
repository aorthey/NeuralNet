...
pkgdatadir = $(datadir)/orthez
pkgincludedir = $(includedir)/orthez
pkglibdir = $(libdir)/orthez
pkglibexecdir = $(libexecdir)/orthez
...
CXXFLAGS = -g -O2
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"NeuralNetwork\" -DPACKAGE_TARNAME=\"neuralnetwork\" -DPACKAGE_VERSION=\"0.01\" -DPACKAGE_STRING=\"NeuralNetwork\ 0.01\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DPACKAGE=\"orthez\" -DVERSION=\"2.6\"
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
PACKAGE = orthez
PACKAGE_BUGREPORT = 
PACKAGE_NAME = NeuralNetwork
PACKAGE_STRING = NeuralNetwork 0.01
PACKAGE_TARNAME = neuralnetwork
PACKAGE_URL = 
